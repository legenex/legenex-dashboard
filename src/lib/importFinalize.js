...
export async function finalizePendingImports(base44, { batchId = null, onProgress = () => {} } = {}) {
  ...
  while (true) {
    const batch = await base44.entities.Lead.filter(filter, '-created_date', pageSize, page * pageSize);
