    ...
    children: [
      { label: 'Dashboard', path: '/distribution', icon: LayoutDashboard, permKey: 'dist_dashboard' },
      {
        ...
        children: [
          ...
          { label: 'Deliveries', path: '/deliveries', icon: Send, permKey: 'dist_deliveries', comingSoon: true },
          { label: 'Brands', path: '/campaigns', tab: 'brands', icon: Tag, permKey: 'dist_campaigns' },
        ],
      },
      { label: 'Webhooks', path: '/settings?tab=inbound-webhooks', icon: Webhook, permKey: 'dist_dashboard' },
