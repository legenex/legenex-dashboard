  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex-shrink-0 whitespace-nowrap rounded-full border border-border bg-card px-3 py-1.5 text-[12.5px] font-medium text-muted-foreground transition-all data-[state=active]:border-primary/40 data-[state=active]:bg-primary/[0.12] data-[state=active]:text-primary",
