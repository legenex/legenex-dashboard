...
// Grouped KPI: headline number, a sub value, and a gap chip.
export default function GroupedKpiCard({ label, headline, subLabel, sub, gapLabel = 'gap', gap, icon: Icon, format = 'money' }) {
  ...
  return (
    <div className="relative bg-card border border-border rounded-[12px] p-5 overflow-hidden hover:border-primary/30 transition-all duration-150">
      ...
      <div className="text-[30px] font-bold text-foreground mt-2 leading-tight font-display">{f(headline)}</div>
